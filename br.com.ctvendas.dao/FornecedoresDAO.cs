...
namespace ControleDeVendas.br.com.ctvendas.dao
{
    public class FornecedoresDAO
    {
        ...
        public void cadastrarFornecedores(Fornecedores obj)
        {
            ...
            {
                MessageBox.Show("Ops! Aconteceu um erro: " + erro);
        ...
        public void alterarFornecedores(Fornecedores obj)
        {
            ...
            {
                //1 passo - definir o cmd sql -  insert into
                string sql = @"update tb_clientes set nome=@nome, cnpj=@cnpj, email=@email, telefone=@telefone, celular=@celular, cep=@cep, endereco=@endereco, numero=@numero, complemento=@complemento, bairro=@bairro, cidade=@cidade, estado=@estado
                                    where id=@id";
